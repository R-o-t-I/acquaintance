...
import {goBack, closeModal, setStory, openPopout, closePopout, setPage} from "./js/store/router/actions";
...
class App extends React.Component {
  ...
  render() {
    const {goBack, setStory, closeModal, popouts, activeView, activeStory, activeModals, panelsHistory, openPopout, closePopout, setPage} = this.props;
          ...
          <AppRoot>
            <FixedLayout vertical="top" className="pageHeader">
              <div className="pageHeaderBlock">
                <img className="pageHeaderLogo" src={logo} onClick={() => setStory('home', 'base')} disabled={activeStory === 'home'}/>
                <Search style={{width: "250px", marginLeft: "12px", marginRight: "12px"}}/>
                <Dropdown
                  className="dropdownNotifications"
                  placement="bottom-start"
                  content={
                    <div style={{marginBottom: "40px", marginTop: "40px"}}>
                      <FixedLayout vertical="top"><div className="titleDropdownNotifications"><div style={{display: "flex"}}><div style={{marginLeft: "12px", marginRight: "auto"}}><b>Уведомления</b></div><div style={{marginLeft: "auto", marginRight: "12px", color: "var(--accent)"}}>Настройки</div></div></div></FixedLayout>
                      ...
                      <FixedLayout onClick={() => setPage('home', 'notifications')} vertical="bottom" style={{textAlign: "center", color: "var(--accent)"}}><div className="allDropdownNotifications">Показать все</div></FixedLayout>
                    </div>
                  }
                >
                  <IconButton style={{marginTop: "auto", marginBottom: "auto", position: "relative"}}><Icon28Notifications style={{color: "var(--header_text_secondary)"}}/><span className="badgeIconNotifications"><span className="textBadgeIconNotifications">21</span></span></IconButton>
                </Dropdown>
                      ...
                      <div className="dropdownProfileBlock">
                        ...
                        <div className="infiDropdownProfileBlock">
                          <Tappable className="tappableInfiDropdownProfileBlock">
                            <div className="blockTappableInfiDropdownProfileBlock">
                              <div className="paddingBlockTappableInfiDropdownProfileBlock">
                                <div className="titleInfiDropdownProfileBlock">Баланс</div>
                                <div className="descriptionInfiDropdownProfileBlock">150</div>
                              </div>
                              <div className="blockIconDropdownNotifications"><Icon28CoinsOutline className="iconDropdownNotifications" /></div>
                            </div>
                          </Tappable>
                          ...
                          <Tappable className="tappableInfiDropdownProfileBlock">
                            <div className="blockTappableInfiDropdownProfileBlock">
                              <div className="paddingBlockTappableInfiDropdownProfileBlock">
                                <div className="titleInfiDropdownProfileBlock">Подписка</div>
                                <div className="descriptionInfiDropdownProfileBlock">активировать</div>
                              </div>
                              <div className="blockIconDropdownNotifications"><Icon28DonateOutline className="iconDropdownNotifications" /></div>
                            </div>
                          </Tappable>
                        </div>
                      </div>
                      <List>
                        <Cell expandable before={<Icon28SettingsOutline width={24} height={24}/>}>Настройки</Cell>
                        <Cell onClick={() => this.openExetPopout()} expandable before={<Icon28DoorArrowRightOutline width={24} height={24} />}>Выход</Cell>
                      </List>
                    </div>
                  }
                >
                  <div style={{position: "absolute", display: "flex", right: 0, marginTop: "10px"}}>
                    <Avatar size={30} src={photo} style={{marginTop: "auto", marginBottom: "auto", marginRight: "5px"}} />
                    <Icon12Dropdown style={{marginTop: "auto", marginBottom: "auto", marginRight: "12px", color: "var(--header_text_secondary)"}} />
                  </div>
                </Dropdown>
                </div>
              </div>
                ...
                <Tabbar>
                  ...
                  <Root id="add" activeView={activeView} popout={popout}>
                    <View
                      ...
                      onSwipeBack={() => goBack()}
                    >
                      <AddPanel id="base" withoutEpic={false} platform={Platform}/>
                    </View>
                  </Root>
                  <Root id="chat" activeView={activeView} popout={popout}>
                    <View
                      ...
                      onSwipeBack={() => goBack()}
                    >
                      <ChatPanel id="base" withoutEpic={false} platform={Platform}/>
                    </View>
                  </Root>
                  <Root id="profile" activeView={activeView} popout={popout}>
                    ...
                    >
                      ...
                      <LoginPanel id="login" withoutEpic={false} platform={Platform} />
                      <RegistrationPanel id="registration" withoutEpic={false} platform={Platform} />
                      <BlockPostPanel id="blockPost" withoutEpic={false} platform={Platform} />
                      <BlockUsersPanel id="blockUsers" withoutEpic={false} platform={Platform} />
                      <HiddenPhotosPanel id="hiddenPhotos" withoutEpic={false} platform={Platform} />
                      <PremiumPanel id="premium" withoutEpic={false} platform={Platform} />
                      <PrivacyPanel id="privacy" withoutEpic={false} platform={Platform} />
                      <SettingsNotificationsPanel id="settingsNotifications" withoutEpic={false} platform={Platform} />
                    </View>
                  </Root>
                </Epic>
              </SplitCol>
...
function mapDispatchToProps(dispatch) {
  return {
    dispatch,
    ...bindActionCreators({setStory, goBack, closeModal, openPopout, closePopout, setPage}, dispatch)
  }
}
